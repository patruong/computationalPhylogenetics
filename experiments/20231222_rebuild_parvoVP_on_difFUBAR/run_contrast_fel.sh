...
(time hyphy contrast-fel --alignment parvo_panleu_trans.fasta  --tree parvo_panleu_trans_tagged_fixed_aligned_internalNode_grouped_rerooted_reassigned_groups.nwk --branch-set G1 --branch-set G2 --p-value 1.00 --q-value 1.00 --cpu 20) 2>&1 | tee output_cpu20/contrastFEL/time_output.txt output_cpu20/contrastFEL/hyphy_output.txt
