...
# 2 group + background
fasta_file = "experiments/20240308_contrastFEL_empirical/data/BLTFull.fas"
tree_file = "experiments/20240308_contrastFEL_empirical/data/epidermal_reroot_retagged.nwk"


seqnames, seqs = read_fasta(fasta_file)
treestring_group_labeled, treestring, tags, original_tags, tag_colors = import_grouped_label_tree(tree_file)
...
iters = 2500
pos_thresh = 0.95
#analysis_name = "experiments/20240318_reroot_rubisco/output/rubisco_C3_vs_C4/treesurgery_and_parallel/analysis"
analysis_name = "experiments/20240308_contrastFEL_empirical/output/epidermal_reroot/treesurgery_and_parallel/analysis"
