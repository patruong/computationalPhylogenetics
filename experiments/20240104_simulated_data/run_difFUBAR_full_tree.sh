...
#(time julia run_difFUBAR_prune_patrick_max_parvoVP.jl --fasta_file "ParvoVP.fasta" --nexus_file "ParvoVP.nwk" --output "$output_dir/patrick_max/") 2>&1 | tee "$output_dir/patrick_max/difFUBAR_output.txt" "$output_dir/patrick_max/time_output.txt"
