...
cd("/home/patrick/git/computationalPhylogenetics/experiments/20231221_datamonkey_difFUBAR")
...
# write Newick from treestring for difFUBAR run
file = open("ParvoVP_treestring.nwk", "w")
write(file, treestring)
close(file)

# write Newick tree for difFUBAR run
nwk_string = MolecularEvolution.newick(tree)
file = open("ParvoVP_treeobject.nwk", "w")
