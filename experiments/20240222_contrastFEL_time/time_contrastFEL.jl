...
for sim in sims
    for rep in reps
        try
            ...
            contrastFEL_time_file_location = "experiments/20240116_rerun_difFUBAR/output/" * "sim_$sim" * "_replicate_" * "$rep" * "/contrastfel/time_output.txt"
...
contrastFEL_time = DataFrame(sim=sim_list, rep=rep_list, contrasteFEL_codon_sites=contrastFEL_codon_site, difFUBAR_codon_sites=difFUBAR_codon_site, contrastFEL_real_time=contrastFEL_real_time_list, difFUBAR_real_time=difFUBAR_real_time_list, contrastFEL_user_time=contrastFEL_user_time_list, difFUBAR_user_time=difFUBAR_user_time_list, contrastFEL_sys_time=contrastFEL_sys_time_list, difFUBAR_sys_time=difFUBAR_sys_time_list)
