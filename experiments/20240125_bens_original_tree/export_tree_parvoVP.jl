...
cd("/home/patrick/git/computationalPhylogenetics/experiments/20240124_recreate_pruned_tree")
...
img |> SVG(analysis_name * "_tagged_input_tree.svg", 30cm, (3 + length(getleaflist(tree)) / 5)cm)