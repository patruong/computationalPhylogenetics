...
(time julia run_difFUBAR_prune_final.jl --fasta_file "data/Ace2_tiny_test.fasta" --nexus_file "data/Ace2_no_background.nex" --output "output/final/") 2>&1 | tee output/final/difFUBAR_output.txt output/final/time_output.txt
