...
#file_name = "omnibus/sims.0.nwk"
#tree = read_newick_tree(file_name)
...
treestring = newick(tree)
treestring, tags, unique_tags = replace_newick_tags(treestring)
tag_colors = generate_hex_colors(length(unique_tags))

# Change tags
# tag_colors, what is tags?


###
cd("/home/ptruong/git/computationalPhylogenetics/workflow_pipeline/")
seqnames_, seqs_ = read_fasta("output/data/test_data/Ace2_tiny_tagged.fasta");
treestring_, tags_, tag_colors_ = import_colored_figtree_nexus_as_tagged_tree("output/data/test_data/Ace2_no_background.nex")
