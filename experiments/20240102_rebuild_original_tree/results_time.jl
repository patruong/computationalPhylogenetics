...
file_contrastfel = "output/contrastfel/time_output.txt"
...
#read_text_file(file_contrastfel)

# Parse time for each file and add rows to the DataFrame
for file in [file_baseline, file_max, file_patrick, file_patrick_max, file_patrick_max_child, file_final, file_contrastfel]
