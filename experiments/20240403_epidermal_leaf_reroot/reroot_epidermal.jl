...
cd("/home/patrick/git/computationalPhylogenetics/experiments/20240403_epidermal_leaf_reroot")
...
# 2 group + backgroundget_unique_tags(json_file)

fasta_file = "data/BLTFull.fas"
json_file = "data/BLTFull.fas.FEL.json"
seqnames, seqs = read_fasta(fasta_file)
...
node = get_node_by_name(tree, "Node55{Physaria}")
tree = MolecularEvolution.recursive_reroot(node, dist_above_child=0.02)
plot_tree(tree, tags, tag_colors)
...
write_string_to_file("data/epidermal_reroot_retagged.nwk", treestring)
