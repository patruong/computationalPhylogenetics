...
savefig("results/hyphySim/ROC/ROC_w2_largerThan_w1.svg")
...
savefig("results/hyphySim/ROC/TPR_threshold_w2_largerThan_w1.svg")
...
#similar
p = plot(plot_x, plot_y, label="Point Estimate", xlabel="Effect Size", ylabel="Proportion of Successes / Power", title="Clopper-Pearson Intervals", ylim=[0, 1])
...
savefig("results/hyphySim/ROC/clopper_pearson_interval_w2_largerThan_w1.svg")
